...
function OffroAiutoPage() {
  ...
  async function handleApplication(requestId: string) {
    ...
    if (!verified) {
      setError('Per candidarti come helper devi prima completare la verifica identità.')
      return
    }
        ...
        <section className="helper-hero" aria-labelledby="offro-title">
          <div className="container helper-hero__grid">
            ...
            <div className="helper-hero__content">
              <p className="helper-hero__badge">Richieste disponibili</p>

              <h1 id="offro-title" className="helper-hero__title">
                Scegli dove puoi <span>dare una mano.</span>
              </h1>

              <p className="helper-hero__text">
                Sfoglia tutte le richieste aperte. Clicca su una richiesta per
                leggere i dettagli e candidarti.
              </p>
              ...
              <div className="helper-hero__points">
                <div className="helper-hero__point">
                  ...
                  <div>
                    ...
                    <p>Vedi subito titolo e compenso senza perdere tempo.</p>
                  </div>
                </div>
                ...
                <div className="helper-hero__point">
                  ...
                  <div>
                    ...
                    <p>Il dettaglio completo si apre solo quando clicchi.</p>
                  </div>
                </div>
                ...
                <div className="helper-hero__point">
                  ...
                  <div>
                    ...
                    <p>Per candidarti serve la verifica identità.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="helper-hero__panel">
              <div className="helper-hero__panel-header">
                ...
                <p>Tutte le richieste aperte: titolo, città e compenso.</p>
              </div>
              ...
              {requests.length === 0 ? (
                ...
                <div className="empty-state">
                  <p>Nessuna richiesta aperta al momento.</p>
                </div>
              ) : (
                      ...
                      >
                        ...
                        >
                          ...
                          <span className="request-accordion__main">
                            ...
                            <small>
                              {request.citta} · {request.categoria}
                            </small>
                          </span>
